...
func (uc *ArticleUseCase) UpdateArticle(id int64, updateArticle *entities.Article) {
	uc.repo.Update(id, updateArticle)
}

func (uc *ArticleUseCase) DeleteArticle(id int64) {
